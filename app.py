...
<head>
  ...
  <style>
    ...
    .total-row { background: #fff8c6; font-weight: bold; }
  </style>
</head>
<body>
...
def upload():
    ...
    if request.method == "POST":
        ...
        html_table = SUMMARY_DF.to_html(index=False, border=0, justify="center", classes="dataframe")
        # выделим строку "ИТОГО" желтым
        html_table = html_table.replace("<td>ИТОГО</td>", "<td class='total-row'>ИТОГО</td>")
